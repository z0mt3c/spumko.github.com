...
The `options` object is the same as the server [`views`](#server.config.views) config object. For a more complete example how to use views with templates,
please check [`examples/templates`](/example/templates).
